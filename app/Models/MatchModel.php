...
class MatchModel extends Model
{
    ...
    protected $allowedFields = ['id_equipe_tournoi_1', 'id_equipe_tournoi_2', 'date_', 'debut_prevision','debut_reel','fin_prevision','fin_reel','id_discipline','score_equipe_1','score_equipe_2','id_type'];
